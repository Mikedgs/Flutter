...
namespace SharpTwit
{
  ...
  public partial class User : Entity<int>
  {
    ...
    [ReverseAssociation("UserWhoFavourites")]
    private readonly EntityCollection<UserFavourite> _userFavourites = new EntityCollection<UserFavourite>();
    ...
    [System.Diagnostics.DebuggerNonUserCode]
    public EntityCollection<UserFavourite> UserFavourites
    {
      get { return Get(_userFavourites); }
    }
  ...
  public partial class Tweet : Entity<int>
  {
    ...
    private readonly EntityCollection<Tweet> _tweets = new EntityCollection<Tweet>();
    [ReverseAssociation("FavouriteTweet")]
    private readonly EntityCollection<UserFavourite> _userFavourites = new EntityCollection<UserFavourite>();
  ...
  public partial class UserFavourite : Entity<int>
  {
    #region Fields
  
    [Column("user_who_favourites_id")]
    private int _userWhoFavouritesId;
    [Column("favourite_tweet_id")]
    private int _favouriteTweetId;

    #endregion
    
    #region Field attribute and view names
    
    /// <summary>Identifies the UserWhoFavouritesId entity attribute.</summary>
    public const string UserWhoFavouritesIdField = "UserWhoFavouritesId";
    /// <summary>Identifies the FavouriteTweetId entity attribute.</summary>
    public const string FavouriteTweetIdField = "FavouriteTweetId";
    ...
    [ReverseAssociation("UserFavourites")]
    private readonly EntityHolder<User> _userWhoFavourites = new EntityHolder<User>();
    [ReverseAssociation("UserFavourites")]
    private readonly EntityHolder<Tweet> _favouriteTweet = new EntityHolder<Tweet>();
    ...
    [System.Diagnostics.DebuggerNonUserCode]
    public User UserWhoFavourites
    {
      get { return Get(_userWhoFavourites); }
      set { Set(_userWhoFavourites, value); }
    }

    [System.Diagnostics.DebuggerNonUserCode]
    public Tweet FavouriteTweet
    {
      get { return Get(_favouriteTweet); }
      set { Set(_favouriteTweet, value); }
    }


    /// <summary>Gets or sets the ID for the <see cref="UserWhoFavourites" /> property.</summary>
    [System.Diagnostics.DebuggerNonUserCode]
    public int UserWhoFavouritesId
    {
      get { return Get(ref _userWhoFavouritesId, "UserWhoFavouritesId"); }
      set { Set(ref _userWhoFavouritesId, value, "UserWhoFavouritesId"); }
    }

    /// <summary>Gets or sets the ID for the <see cref="FavouriteTweet" /> property.</summary>
    [System.Diagnostics.DebuggerNonUserCode]
    public int FavouriteTweetId
    {
      get { return Get(ref _favouriteTweetId, "FavouriteTweetId"); }
      set { Set(ref _favouriteTweetId, value, "FavouriteTweetId"); }
    }
  ...
  public partial class SharpTwitUnitOfWork : Mindscape.LightSpeed.UnitOfWork
  {
    ...
    public System.Linq.IQueryable<UserFavourite> UserFavourites
    {
      get { return this.Query<UserFavourite>(); }
    }
